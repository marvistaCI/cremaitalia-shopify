...
| **Store Operating Standards** (v1.11) | how the store **buys & sells** — pricing, shelves, discounts, fulfilment | [`store-operating-standards.md`](store-operating-standards.md) |
...
```
py docs/standards/render.py store-operating-standards.md "Store_Operating_Standards_v1.11.pdf"
