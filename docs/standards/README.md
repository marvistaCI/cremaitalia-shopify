...
|---|---|---|
| **Brand Standards** (v2.2) | how the store **looks & speaks** — color, type, voice, logo | [`brand-standards/`](brand-standards/) |
| **Store Operating Standards** (v1.14) | how the store **buys & sells** — pricing, shelves, discounts, fulfilment | [`store-operating-standards.md`](store-operating-standards.md) |
...
```
py docs/standards/render.py store-operating-standards.md "Store_Operating_Standards_v1.14.pdf"
